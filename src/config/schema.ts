...
export const runtimeConfigSchema = z.object({
  ...
  POLYGATE_REQUIRE_API_TOKEN_FOR_PRIVATE: booleanish.default(true),
  POLYGATE_API_TOKENS: csvList,
  POLYGATE_API_TOKEN_HEADER: z.string().min(1).default("x-polygate-token"),
